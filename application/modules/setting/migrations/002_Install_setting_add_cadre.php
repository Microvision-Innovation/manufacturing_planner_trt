...
class Migration_Install_setting_add_cadre extends Migration
{
	...
	private $permission_values = array(
			array(
            'name'          => 'Vision.Settings.Can_View_Management_Cadre_Salaries',
            'description'   => 'Can View Management Salaries.',
            'status'        => 'active',
        ),
