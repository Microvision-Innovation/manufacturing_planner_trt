...
class Migration_Install_mappings_user_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name'          => 'Planner.Mappings.View',
			'description'   => 'Access to counties and sub-counties managmement page.',
			'status'        => 'active',
		),
		array(
			'name'          => 'Planner.Job_types.Edit',
			'description'   => 'Editing and adding of Counties.',
			'status'        => 'active',
		),
		array(
			'name'          => 'Planner.Job_areas.Edit',
			'description'   => 'Editing and adding of sub-counties.',
			'status'        => 'active',
		),
		array(
			'name'          => 'Planner.Job_lines.Edit',
			'description'   => 'Editing and adding of sub-counties.',
			'status'        => 'active',
		)
