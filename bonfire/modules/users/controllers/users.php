...
class Users extends Front_Controller
{
	...
	public function __construct()
	{
		...
		$this->load->model('users/backup_model');
	...
	{    
		...
		if ($this->auth->is_logged_in() === FALSE)
		{
			...
			Template::set_view('users/users/_login');
			...
			if (isset($_POST['send']))
			{
				...
				if ($this->form_validation->run() !== FALSE)
				{
					...
					if ($user !== FALSE)
					{
						...
						{
							Template::set_message(lang('us_reset_pass_message'), 'alert fresh-color alert-success');
						}
						else
						{
							Template::set_message(lang('us_reset_pass_error'). $this->emailer->error, 'alert fresh-color alert-danger');
						}
					}
					else
					{
						Template::set_message(lang('us_invalid_email'), 'alert fresh-color alert-danger');
					}//end if
				}//end if
			}//end if
			Template::set_view('users/users/_forgot_password');
